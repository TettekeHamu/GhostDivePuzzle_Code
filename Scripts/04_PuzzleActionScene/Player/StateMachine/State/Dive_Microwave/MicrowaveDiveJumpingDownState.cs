...
namespace TettekeKobo.GhostDivePuzzle
{
    ...
    /// 
    /// </summary>
    public class MicrowaveDiveJumpingDownState : IHamuState,ICollisionEnemy
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public MicrowaveDiveJumpingDownState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
