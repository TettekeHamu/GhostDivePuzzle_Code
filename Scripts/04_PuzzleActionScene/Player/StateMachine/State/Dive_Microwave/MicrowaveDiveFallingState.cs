...
{
    /// <summary>
    /// MicrowaveDiveFallingState
    /// </summary>
    public class MicrowaveDiveFallingState : IHamuState,ICollisionEnemy,IDisposable
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public MicrowaveDiveFallingState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
        ...
        public void MyUpdate()
        {
            ...
            if (onGround) transitionState.TransitionState(PlayerStateType.MicrowaveDivingLand);
        }
        ...
        private async UniTaskVoid AsyncStartFalling(CancellationToken token)
        {
            ...
            {
                //落下させる
                playerComponent.AnimationManager.PlayerAnimator.SetBool(playerComponent.AnimationManager.IsMicrowaveFalling, true);
