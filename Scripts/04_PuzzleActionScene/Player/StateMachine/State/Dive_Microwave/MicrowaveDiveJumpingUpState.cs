...
namespace TettekeKobo.GhostDivePuzzle
{
    ...
    /// 
    /// </summary>
    public class MicrowaveDiveJumpingUpState : IHamuState,ICollisionEnemy
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public MicrowaveDiveJumpingUpState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
            requiredTime = 0.5f;
        ...
        public void MyUpdate()
        {
            ...
            {
                //待機させずに落下させる
                transitionState.TransitionState(PlayerStateType.MicrowaveDivingJumpDown);
            }
        }
