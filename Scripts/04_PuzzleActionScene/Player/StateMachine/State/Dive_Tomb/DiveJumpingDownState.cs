...
{
    /// <summary>
    /// お墓にダイブ中 & ジャンプで落下中のState
    /// </summary>
    public class DiveJumpingDownState : IHamuState,ICollisionEnemy
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public DiveJumpingDownState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
