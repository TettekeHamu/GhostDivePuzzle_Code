...
namespace TettekeKobo.GhostDivePuzzle
{
    ...
    /// ダイブ中に落下しているときのState
    /// </summary>
    public class DiveFallingState : IHamuState,ICollisionEnemy,IDisposable
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public DiveFallingState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
        ...
        public void MyUpdate()
        {
            ...
            if (onGround) transitionState.TransitionState(PlayerStateType.DivingLand);
        }
        ...
        private async UniTaskVoid AsyncStartFalling(CancellationToken token)
        {
            ...
            {
                //落下させる
                playerComponent.AnimationManager.PlayerAnimator.SetBool(playerComponent.AnimationManager.IsFalling, true);
