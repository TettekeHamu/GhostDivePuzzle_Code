...
namespace TettekeKobo.GhostDivePuzzle
{
    ...
    /// 
    /// </summary>
    public class RefrigeratorDiveLandingState : IHamuState,ICollisionEnemy,IDisposable
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public RefrigeratorDiveLandingState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
        ...
        public void Enter()
        {
            fallingFuncManager.StopFalling(PlayerDiveType.DiveRefrigerator, cancellationTokenSource.Token);
        }
