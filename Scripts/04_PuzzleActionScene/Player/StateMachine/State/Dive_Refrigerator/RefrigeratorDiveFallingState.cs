...
{
    /// <summary>
    /// RefrigeratorDiveFallingState
    /// </summary>
    public class RefrigeratorDiveFallingState : IHamuState, ICollisionEnemy, IDisposable
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public RefrigeratorDiveFallingState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
        ...
        private async UniTaskVoid AsyncStartFalling(CancellationToken token)
        {
            ...
            {
                //落下させる
                playerComponent.AnimationManager.PlayerAnimator.SetBool(playerComponent.AnimationManager.IsRefrigeratorFalling, true);
