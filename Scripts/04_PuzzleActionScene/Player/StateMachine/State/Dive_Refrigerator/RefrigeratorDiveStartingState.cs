...
namespace TettekeKobo.GhostDivePuzzle
{
    ...
    /// オハカにダイブの開始した時のState
    /// </summary>
    public class RefrigeratorDiveStartingState : IHamuState,IDisposable
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public RefrigeratorDiveStartingState(ITransitionState<PlayerStateType> ts, PlayerComponentController pcc)
        {
            transitionState = ts;
            playerComponent = pcc;
        ...
        public void Enter()
        {
            enterFuncManager.DiveStart(PlayerDiveType.DiveRefrigerator, cancellationTokenSource.Token);
        }
