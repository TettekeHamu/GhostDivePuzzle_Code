...
{
    /// <summary>
    /// MicrowaveDivedFallingState
    /// </summary>
    public class MicrowaveNotDivedFallingState : IHamuState
    {
        /// <summary>
        ...
        /// コンストラクター
        /// </summary>
        public MicrowaveNotDivedFallingState(ITransitionState<MicrowaveStateType> ts, MicrowaveComponentController mcc)
        {
            transitionState = ts;
